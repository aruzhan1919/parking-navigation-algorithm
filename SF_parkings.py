...
# 1. Центр Сан-Франциско (Downtown / Union Square)
SAN_FRANCISCO_CENTER = (37.7749, -122.4194)
...
# 3. Создаём карту
m = folium.Map(location=SAN_FRANCISCO_CENTER, zoom_start=12)
...
# 5. Сохраняем карту
m.save("san_francisco_parkings.html")
